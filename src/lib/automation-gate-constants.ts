 ...
 */
export const AUTOMATION_GATE_VERSION = 2 as const;
export const AUTOMATION_GATE_CACHE_KEY = "automation-gate-v2";
export const AUTOMATION_GATE_TAG = "automation-gate:v2";

/** Even a completely quiet site is re-checked at least this often. */
export const AUTOMATION_GATE_HARD_HORIZON_MS = 15 * 60_000;
