 ...
 */
export const AUTOMATION_GATE_VERSION = 3 as const;
export const AUTOMATION_GATE_CACHE_KEY = "automation-gate-v3";
export const AUTOMATION_GATE_TAG = "automation-gate:v3";
