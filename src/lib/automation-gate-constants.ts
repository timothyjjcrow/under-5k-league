 ...
 */
export const AUTOMATION_GATE_VERSION = 7 as const;
export const AUTOMATION_GATE_CACHE_KEY = "automation-gate-v7";
export const AUTOMATION_GATE_TAG = "automation-gate:v7";
